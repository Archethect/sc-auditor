...
2. Call `mcp__sc-auditor__run-slither` with `{rootDir: "<cwd>"}`.
3. Call `mcp__sc-auditor__run-aderyn` with `{rootDir: "<cwd>"}`.
4. Call `mcp__sc-auditor__get_checklist`.
...
- Allowed tools: `Read`, `Glob`, `Grep`, `mcp__sc-auditor__build-system-map`
...
Call `mcp__sc-auditor__derive-hotspots` with `{rootDir: "<cwd>"}` (add `{mode: "deep"}` or `{mode: "benchmark"}` if configured).
...
- Allowed tools: `Read`, `Glob`, `Grep`, `mcp__sc-auditor__generate-foundry-poc`, `mcp__sc-auditor__run-echidna`, `mcp__sc-auditor__run-medusa`, `mcp__sc-auditor__run-halmos`, `mcp__sc-auditor__search_findings`
...
- Allowed tools: `Read`, `Glob`, `Grep`, `mcp__sc-auditor__verify-finding`, `mcp__sc-auditor__search_findings`
